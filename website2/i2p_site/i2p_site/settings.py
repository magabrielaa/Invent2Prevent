"""
Django settings for i2p_site project.
...
ALLOWED_HOSTS = ['disableviolence.pythonanywhere.com', '127.0.0.1']
...
WSGI_APPLICATION = "i2p_site.wsgi.application"
